...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pathToRegexp = __webpack_require__(1);
	...
	function pathToBundle(url, routes) {
	    ...
	    routes.forEach(function (r) {
	        var re = (0, _pathToRegexp2.default)(r.path);
	    ...
	    var keys = [];
	    var pathReg = (0, _pathToRegexp2.default)(matchRule.path, keys);
	...
	function bundleToPath(url, routes) {
	    ...
	    /*use pathToRegexp*/
	    var keys = [];
	    (0, _pathToRegexp2.default)(matchRule.path, keys);
